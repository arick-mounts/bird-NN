...
class DQNAgent(object):
    ...
    def __init__(self):
        ...
        self.learning_rate = 0.0025 #0015
    ...
    def get_state(self, game, player, pipeU, pipeD):
        ...
        state = [
            ...
            player.playerrect.top > pipeU.piperect.bottom+20,
            player.playerrect.bottom < pipeD.piperect.top-20,
    ...
    def set_reward(self, pipe, crash, between):
        self.reward = 0
        if crash:
            self.reward = -10
            return self.reward
